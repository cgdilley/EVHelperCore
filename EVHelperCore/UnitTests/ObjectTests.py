...
class TestObjects(TestCase):
    ...
    def test_name(self):
        name_obj = Name("a", localized_names={"de": "b"},
                        variant_name=PrefixVariantName("c", localized_names={"de": "d"}))
        name_json = {
            "default": "a",
            "localized": {
                "de": "b"
        ...
        name_obj2 = Name("e", localized_names={})
        name_json2 = {
            "default": "e",
            "localized": {}
        }
        ...
        self.assertIsInstance(from_json.variant_name, PrefixVariantName)
        ...
        self.assertIsNone(from_json2.variant_name)
    ...
    def test_typing(self):
        ...
        mono = Typing(Type.FIRE)
        dual = Typing(Type.FIRE, Type.WATER)
    ...
    def test_stats(self):
        ...
        self.assertEqual(252, EV(Stat.ATTACK, EV.MAX).value)
        self.assertEqual(248, EV(Stat.ATTACK, EV.MAX - 1, round_off=True).value)
        ...
        self.assertEqual(31, IV(Stat.ATTACK, IV.MAX).value)
    ...
    def test_abilities(self):
        ...
        ability_list = AbilityList(primary_ability=Ability(name="a"),
                                   secondary_ability=Ability(name="b"),
                                   hidden_ability=Ability(name="c"))
        ...
        ability_list2 = AbilityList(primary_ability=Ability(name="a"))
    ...
    def test_misc_info(self):
        ...
        evo = Evolution("RATTATA", "RATICATE", LevelUpEvolutionType(20))
        evo_json = {"from": "RATTATA", "to": "RATICATE", "evo": {"type": "level_up", "level": 20}}
        ...
        evo_line = EvolutionLine(
            "POLIWAG",
            (Evolution("POLIWAG", "POLIWHIRL", LevelUpEvolutionType(25)),
             EvolutionLine(
                 "POLIWHIRL",
                 (Evolution("POLIWHIRL", "POLIWRATH", UnknownEvolutionType()),
                  EvolutionLine("POLIWRATH")),
                 (Evolution("POLIWHIRL", "POLITOED", UnknownEvolutionType()),
                  EvolutionLine("POLITOED")))))
        evo_line_json = {
            "pokemon_id": "POLIWAG",
            "evolutions": [
                {
